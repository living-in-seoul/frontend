...
const BottomSheet = ({
  ...
  return (
    <div className="relative w-full h-full">
      ...
      <div
        ref={ref}
        className={`fixed max-w-md bg-white z-50 bottom-0 border-t-2 rounded-tl-2xl rounded-tr-2xl pt-7 pb-2 shadow-2xl border-neutral-200 left-1/2 -translate-x-1/2 w-full transform transition-transform duration-500 ${
